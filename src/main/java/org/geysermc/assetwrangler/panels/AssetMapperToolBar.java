...
public class AssetMapperToolBar extends JMenuBar {
    public AssetMapperToolBar(AssetViewerWindow window) {
        Config config = Main.CONFIG;

        if (window.isForMapping()) {
            MappingsWindow main = (MappingsWindow) window;
            ...
            createPopupMenu(
                    ...
                    TooltipItem.optionToggle("Add Checkered Background", config::addCheckeredBackground, config::addCheckeredBackground, (item) -> {
                        main.refreshView();
                    })
            );
            createPopupMenu(
            ...
            createPopupMenu(
                    "Info",
                    TooltipItem.of("Version", () -> {
                        new InfoWindow(window.getFrame());
                    })
            );
        }
    }
